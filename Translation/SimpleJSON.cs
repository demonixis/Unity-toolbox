 ...
 * 
 * Modified by Demonixis (CYannick)
 * 2014-03-01
 * 
 * Written by Bunny83 
 * 2012-06-09
...
namespace SimpleJSON
{
    ...
    public class JSONNode
    {
        ...
        public virtual string[] GetKeys() { return new string[0]; }
    ...
    public class JSONClass : JSONNode, IEnumerable
    {
        ...
        public Dictionary<string, JSONNode> Dict { get { return m_Dict; } }

        public override string[] GetKeys()
        {
            string[] keys = new string[m_Dict.Count];
            int i = 0;

            foreach (KeyValuePair<string, JSONNode> keyValue in m_Dict)
            {
                keys[i] = keyValue.Key;
                i++;
            }
